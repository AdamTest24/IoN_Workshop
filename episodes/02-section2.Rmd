...
We use Matplotlib’s image module, from which we import function `imread` to store the image in a variable called image. The function `imread` can interpret many different image formats, including jpg, png and tif images.
